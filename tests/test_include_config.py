...
internals are missing from the capture by default. Enabling the knob registers an
...
def test_open_shadow_content_missing_by_default(data_url: DataUrl) -> None:
    ...
    assert "OPENMARKER" not in r.html
